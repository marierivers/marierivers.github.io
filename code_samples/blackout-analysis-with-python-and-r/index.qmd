...
#### Functions to read imagery data
...
```{python}
#| include: false
del(dnb_feb7_h08v05_py, dnb_feb7_h08v06_py, dnb_feb16_h08v05_py, dnb_feb16_h08v06_py)
```
...
#| warning: false
#| echo: false
plot(feb7_roi, main = "DNB at Sensor Radiance Feb 7, 2021", axes = TRUE, key.pos = NULL)
```
:::
...
#| warning: false
#| echo: false
plot(feb16_roi, main = "DNB at Sensor Radiance Feb 16, 2021", axes = TRUE, key.pos = NULL)
```
:::
:::::
...
#remove data not needed anymore
rm(acs_age_sex, acs_race, acs_hispanic_latino, acs_children_household, acs_poverty, acs_income)
gc()
```
...
#remove data not needed anymore
rm(blackout_buildings_census_3083, no_blackout_buildings_3083,
   blackout_buildings_3083, blackout_mask_3083, blackout_mask_4326,
   blackout_threshold_vector, feb16_roi, feb16_merged, feb7_roi, feb7_merged,
   all_building_data_3083, counts_of_lost_power_by_census_tract,
   census_tract_blackout_data_with_geometry, census_tract_blackout_data,
   acs_income_df, acs_layer_names, acs_poverty_df, acs_race, acs_race_df, acs_income,
   acs_geoms, buildings_3083, buildings_4326, census_tract_data, census_tract_data_3083,
   census_tract_data_roi_4326, census_tract_data_roi_3083, census_tract_data_roi_4326,
   highways, highways_3083, highways_buffer_3083, highways_buffer_4326, acs_age_sex_df,
   acs_children_household_df, acs_hispanic_latino_df, census_tract_data_4326, no_blackout_buildings_census_3083)
gc()
```

```{python}
#| include: false
del(all_building_data_3083_py, blackout_buildings_3083_py, blackout_buildings_census_3083_py, blackout_mask_3083_py, blackout_threshold_data_py)
```
